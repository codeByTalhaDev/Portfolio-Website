...
const About = () => {
  return (
    ...
    >
      ...
      {/* Content */}
      <div data-aos="fade-right" className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
        ...
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-7 md:leading-8 mb-4 md:mb-6">
            I am a BS Computer Science student passionate about frontend development.
            I enjoy building modern, responsive and interactive web applications using React.
          </p>

          <p className="text-gray-400 text-sm sm:text-base md:text-lg leading-7 md:leading-8 mb-8 md:mb-10">
            My goal is to become a professional full stack developer and work on real-world scalable projects.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-6 sm:gap-10">
            ...
            <div className="text-center">
              <h4 className="text-3xl sm:text-4xl font-bold text-cyan-400">5+</h4>
              <p className="text-gray-400 text-sm sm:text-base">Projects</p>
            </div>

            <div className="text-center">
              <h4 className="text-3xl sm:text-4xl font-bold text-cyan-400">1+</h4>
              <p className="text-gray-400 text-sm sm:text-base">Years Learning</p>
            </div>

            <div className="text-center">
              <h4 className="text-3xl sm:text-4xl font-bold text-cyan-400">BSCS</h4>
